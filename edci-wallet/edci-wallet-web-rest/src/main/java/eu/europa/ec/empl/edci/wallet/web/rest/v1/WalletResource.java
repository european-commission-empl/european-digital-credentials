...
public class WalletResource {
    ...
    public WalletResponseView modifyWallet(
        ...
        return walletRestMapper.toVOResponse(walletService.updateWalletByWalletAddress(walletDTO.getWalletAddress(), walletModifyView.getUserEmail()));
    }
    ...
    public ResponseEntity deleteWallet(
            ...
            @ApiParam(value = "locale") @RequestParam(value = Parameter.LOCALE, required = false) String locale) {
        WalletDTO walletDTO = walletService.fetchWalletByUserId(userId);
        walletService.deleteWalletByWalletAddress(walletDTO.getWalletAddress());
