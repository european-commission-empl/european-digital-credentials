...
public class ShareLinkResource implements CrudResource {
    ...
    private static final Logger logger = LogManager.getLogger(ShareLinkResource.class);
    ...
    public ResponseEntity<PagedResources<ShareLinkInfoView>> listShareLink(
        ...
        Specification<ShareLinkDAO> specif = buildSearchSpecification("credentialDAO.walletDAO.userId:" + userId + expiredStr);
