...
public class WalletServiceTest extends AbstractUnitBaseTest {
    ...
    public void addWalletEntity_shouldCreatedAWallet_whenUserIdAndEmailNotExists() throws Exception {
        ...
        Mockito.when(walletMapper.toDTO(ArgumentMatchers.any(), ArgumentMatchers.any(CycleAvoidingMappingContext.class))).thenReturn(wallet);
        Mockito.when(walletRepository.save(walletDao)).thenReturn(walletDao);
        Mockito.when(walletMapper.toDAO(ArgumentMatchers.any(WalletDTO.class), ArgumentMatchers.any(CycleAvoidingMappingContext.class))).thenReturn(walletDao);
    ...
    public void addWalletEntity_shouldThrowException_whenUserEmailAlreadyExists() throws Exception {
        ...
        Mockito.when(walletRepository.fetchByUserId(ArgumentMatchers.anyString())).thenReturn(null);
        Mockito.when(walletMapper.toDTO(ArgumentMatchers.any(WalletDAO.class), ArgumentMatchers.any(CycleAvoidingMappingContext.class))).thenReturn(wallet);
    ...
    public void addBulkWalletEntity_shouldCreateTemporalWallet_whenNoWalletExistsWithSameEmail() throws Exception {
        ...
        WalletDAO aux = walletService.addBulkWalletEntity(wallet);
    ...
    @Test(expected = EDCIException.class)
    public void addBulkWalletEntity_shouldThrowException_whenWalletExistsWithSameEmail() throws Exception {
