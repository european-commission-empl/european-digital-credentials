...
public class CredentialService {
    ...
    public ResponseEntity<byte[]> downloadCredential(String userId, String uuid, boolean retrieveVP) {
        ...
        try {
            ...
            byte[] resultCredentialBytes = null;
            ...
            if (retrieveVP) {
                ...
                try (StringWriter stringWriter = new StringWriter()) {
                    ...
                    resultCredentialBytes = stringWriter.toString().getBytes();
                }
                downloadVerifiablePresentationXML(credentialDTO, null);
            } else {
                resultCredentialBytes = credentialDTO.getCredentialXML();
            }

            return new ResponseEntity<byte[]>(resultCredentialBytes,
