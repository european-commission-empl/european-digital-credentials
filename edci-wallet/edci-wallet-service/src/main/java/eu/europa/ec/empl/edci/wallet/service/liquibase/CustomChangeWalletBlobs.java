...
//        List<LocalizableDTO> nonEmptyLocalizables = Arrays.stream(localizables).filter(localizable -> localizable != null && localizable.getContents() != null && !localizable.getContents().isEmpty()).collect(Collectors.toList());
