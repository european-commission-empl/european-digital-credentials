...
public interface WalletCrudService<T extends IGenericDAO> extends CrudService<T> {
    ...
    static final Logger logger = LogManager.getLogger(WalletCrudService.class);
...
//        if (objectDAO instanceof AuditedDAO && objectDAO.getHashCodeSeed() != null) {
//            AuditedDAO d = (AuditedDAO) getRepository().getOne(objectDAO.getHashCodeSeed());
