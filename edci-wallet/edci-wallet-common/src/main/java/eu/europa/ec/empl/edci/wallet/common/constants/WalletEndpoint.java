...
public class WalletEndpoint {
    ...
    public class V1 {
        ...
        public static final String VERIFY_XML = "/verifyXML";
        public static final String VERIFY = "/verify";

        public static final String SHARELINKS_BASE = "/sharelinks";
        public static final String SHARELINK_SHARE = "/sharelink";

        public static final String WALLETS_BULK = "/bulk";
        public static final String WALLETS_BASE = "/wallets";
