...
public class DSSEDCICertificateServiceTest extends AbstractUnitBaseTest {
    ...
    public void checkCertificate_ShouldThrowBadPasswordException_WhenPasswordIsBad() {
        try {
            ...
            Assert.assertEquals(ESealMessageKeys.Exception.ESeal.LOCAL_CERTIFICATE_BAD_PASSWORD, e.getMessage());
        }
    }
    ...
    public void checkCertificate_ShouldThrowBadPathException_WhenCertPathIsBad() {
        try {
            ...
            Assert.assertEquals(ESealMessageKeys.Exception.ESeal.LOCAL_CERTIFICATE_NOT_FOUND, e.getMessage());
        }
    }
    ...
    private String addCertificateWrappers(String certificate) {
        return ESealConstants.Certificate.CERTIFICATE_BEGIN_MARKER + certificate + ESealConstants.Certificate.CERTIFICATE_END_MARKER;
    }
}
