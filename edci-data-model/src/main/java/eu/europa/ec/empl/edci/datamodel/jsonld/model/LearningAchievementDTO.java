...
@JsonTypeInfo(use = JsonTypeInfo.Id.DEDUCTION, property = "type", visible = true, defaultImpl = LearningAchievementDTO.class)
public class LearningAchievementDTO extends ClaimDTO {
    ...
    @JsonCreator
    public LearningAchievementDTO(String uri) {
        super(uri);
    }
