...
public class ValidationResult {
    ...
    public void addValidationError(String messageKey, String... messageVariables) {
        ValidationError validationError = new ValidationError(messageKey, messageVariables);
        this.getValidationErrors().add(validationError);
    }
