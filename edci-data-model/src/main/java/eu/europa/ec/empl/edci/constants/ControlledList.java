...
public enum ControlledList {
    ...
    CLAIM_TYPE("http://data.europa.eu/snb/claim-type/25831c2", RDFParser.class, "claim-type", true),
    EVIDENCE_TYPE("http://data.europa.eu/snb/evidence-type/25831c2", RDFParser.class, "evidence-type", true),
    GRADE_STATUS("http://data.europa.eu/snb/grade-status/25831c2", RDFParser.class, "grade-status", false),
    ACCREDITATION_DECISION("http://data.europa.eu/snb/accreditation-decision/25831c2", RDFParser.class, "accreditation-decision", true),
    LEARNING_SCHEDULE("http://data.europa.eu/snb/learning-schedule/25831c2", RDFParser.class, "learning-schedule", false),
    ...
    TARGET_GROUPS("http://data.europa.eu/snb/target-group/25831c2", RDFParser.class, "target-groups", false),
