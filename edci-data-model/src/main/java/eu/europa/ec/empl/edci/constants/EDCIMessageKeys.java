...
public class EDCIMessageKeys {
    ...
    public class Acreditation {
        ...
        public static final String ACCREDITED_CRED_NO_ACCREDITATION_FOUND = "accredited.cred.no.accreditation.found";
        public static final String ACCREDITATION_TYPE_NOT_FOUND = "accreditation.type.not.found";
        public static final String ACCREDITING_AGENT_NOT_FOUND = "accrediting.agent.not.found";
        ...
        public static final String CREDENTIAL_PROFILE_NOT_COVERED = "credential.profile.not.covered";
        public static final String EQF_LEVEL_NOT_COVERED = "eqf.level.not.covered";
        public static final String ISCEDF_CODE_NOT_COVERED = "iscedf.codes.not.covered";
    }
}
