...
public class CredentialDetailService {
    ...
    public EuropassDiplomaDTO getWalletDiplomaHTML(String credentialUUID, String walletAddress, String locale) {
    ...
    public EuropassDiplomaDTO getCredentialDiploma(MultipartFile file, String locale) {
        ...
        if (StringUtils.isBlank(locale)) {
            LocaleContextHolder.setLocale(credentialUtil.guessPrimaryLanguage(europassCredentialDTO));
        }
    ...
    public EuropeanDigitalCredentialDTO getCredentialDetail(String walletAddress, String credentialUUID) {
        EuropeanDigitalCredentialDTO europassCredentialDTO = null;
        Map<String, String> parameters = new HashMap<>();
        parameters.put(Parameter.WALLET_ADDRESS, walletAddress);
        try {
    ...
    public List<VerificationCheckView> getWalletCredentialVerification(String credentialUUID, String walletAddress) {
