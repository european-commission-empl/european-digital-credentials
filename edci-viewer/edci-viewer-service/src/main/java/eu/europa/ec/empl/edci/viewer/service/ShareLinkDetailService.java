...
public class ShareLinkDetailService {
    ...
    public EuropassDiplomaDTO getSharedCredentialDiploma(String shareHash, String locale) {
        ...
        try {
            ...
            europassDiplomaDTO = this.getCredentialDiploma(europassCredentialDTO, shareLinkFetchResponseDTO.getExpirationDate(), locale);
    ...
    public EuropassDiplomaDTO getCredentialDiploma(EuropeanDigitalCredentialDTO europeanDigitalCredentialDTO, Date expirationDate, String locale) throws IOException {
        if (StringUtils.isBlank(locale)) {
            LocaleContextHolder.setLocale(credentialUtil.guessPrimaryLanguage(europeanDigitalCredentialDTO));
        }
        EuropassDiplomaDTO europassDiplomaDTO = new EuropassDiplomaDTO();
        europassDiplomaDTO.setBase64DiplomaImages(this.getDiplomaUtil().getBase64DiplomaImages(europeanDigitalCredentialDTO, locale));
