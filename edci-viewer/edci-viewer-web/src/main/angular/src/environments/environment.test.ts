...
export const environment = {
    ...
    hasLabelsOnly: true,
    apiBaseUrl: 'https://www.test.ec.europa.eu/europass/edci-viewer',
    issuerBaseUrl: 'https://www.test.ec.europa.eu/europass/edci-issuer',
    walletBaseUrl: 'https://www.test.ec.europa.eu/europass/edci-wallet',
    europassRoot: 'https://webgate.test.ec.europa.eu/europass',
    ePortfolioUrl:
