...
export class AchievementLearningOutcomesPanelComponent implements OnInit {
    ...
    /* private sortRelatedSkillsByTargetFramework(relatedSkills: LinkFieldView[]): {
        [key: string]: LinkFieldView[];
    } {
        if (relatedSkills) {
            const sortedRelatedSkills: {
                [key: string]: LinkFieldView[];
            } = {};
            ...
            console.log('sorted related skills',sortedRelatedSkills);
            console.log(JSON.stringify(sortedRelatedSkills));
