...
export class V1Service {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, locale?: string, observe?: 'body', reportProgress?: boolean): Observable<ByteArrayResource>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, locale?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ByteArrayResource>>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, locale?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ByteArrayResource>>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, locale?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    /**
     * Dummy test resource for Swagger implementation
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public getSomething(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.basePath}/v1/test/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
