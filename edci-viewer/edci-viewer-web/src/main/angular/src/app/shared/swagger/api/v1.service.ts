...
export class V1Service {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public downloadCredential(userId: string, body?: CredentialBaseView, locale?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<string>>;
    public downloadCredential(userId: string, body?: CredentialBaseView, locale?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<string>>>;
    public downloadCredential(userId: string, body?: CredentialBaseView, locale?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<string>>>;
    public downloadCredential(userId: string, body?: CredentialBaseView, locale?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, expirationDate?: Date, locale?: string, observe?: 'body', reportProgress?: boolean): Observable<ByteArrayResource>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, expirationDate?: Date, locale?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ByteArrayResource>>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, expirationDate?: Date, locale?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ByteArrayResource>>;
    public downloadVerifiablePresentationPDF(userId: string, body?: CredentialBaseView, pdfType?: string, expirationDate?: Date, locale?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (userId === null || userId === undefined) {
            throw new Error('Required parameter userId was null or undefined when calling downloadVerifiablePresentationPDF.');
        }
        ...
        return this.httpClient.post<ByteArrayResource>(`${this.basePath}/v1/credentials/${encodeURIComponent(String(userId))}/verifiable`,
            body,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
