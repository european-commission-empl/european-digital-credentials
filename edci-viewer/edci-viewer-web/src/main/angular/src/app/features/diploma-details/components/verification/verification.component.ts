...
export class VerificationComponent implements OnInit, OnDestroy {
    JSONFile: Blob = new Blob([sessionStorage.getItem('diplomaJSON')], {
        type: 'text/xml',
    });
    ...
    private getVerificationData() {
        if (this.credId) {
            ...
            this.getCredentialVerificationByFile();
        }
    }
    ...
    private getCredentialVerificationByFile(): void {
        this.apiService
            .getCredentialVerification(this.JSONFile, this.language)
            .subscribe(
                (steps: VerificationCheckView[]) => {
                    this.saveSteps(steps);
                },
    ...
    private addRibbonStep(
        ...
        this.shareDataService.setVerificationSteps(this.steps);
