...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'organisation', component: IssuingOrganizationComponent, },
            { path: 'subject', component: CredentialOwnerComponent, },
            ...
            { path: 'diploma', component: VerificationComponent, },
            { path: 'entitlement', component: EntitlementsComponent, },
        ],
    },
];
