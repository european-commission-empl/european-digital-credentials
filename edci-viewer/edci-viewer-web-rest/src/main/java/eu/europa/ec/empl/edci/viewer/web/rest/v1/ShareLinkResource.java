...
public class ShareLinkResource {
    ...
    public EuropassCredentialPresentationView getSharedCredentialDetails(@PathVariable(Parameter.SHARE_HASH) String shareHash,
        ...
        CredentialHolderDTO credential = shareLinkDetailService.getSharedCredentialDetail(shareHash);
        if (StringUtils.isEmpty(locale)) {
            LocaleContextHolder.setLocale(LocaleUtils.toLocale(credential.getCredential().getPrimaryLanguage()));
        }
    ...
    @ApiOperation(value = "Get Shared Credential XML")
    ...
    public ResponseEntity<byte[]> downloadShareLinkCredentialXML(@PathVariable(Parameter.SHARE_HASH) String shareHash,
                                                                   @ApiParam(value = "locale") @RequestParam(value = Parameter.LOCALE, required = false) String locale) {
        return shareLinkService.downloadShareLinkCredentialXML(shareHash);
    }
