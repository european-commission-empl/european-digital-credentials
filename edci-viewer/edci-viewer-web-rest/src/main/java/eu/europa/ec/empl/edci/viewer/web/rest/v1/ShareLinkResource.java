...
@RequestMapping(value = Version.V1 + Endpoint.V1.SHARELINKS_BASE)
...
public class ShareLinkResource {
    ...
    @GetMapping(value = Parameter.Path.SHARE_HASH + Endpoint.V1.DIPLOMA,
    ...
    @GetMapping(value = Parameter.Path.SHARE_HASH + Endpoint.V1.DETAILS, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    ...
    @GetMapping(value = Parameter.Path.SHARE_HASH + Endpoint.V1.SHARELINK_PRESENTATION, produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
    @ApiResponses({
    ...
    @GetMapping(value = Parameter.Path.SHARE_HASH + Endpoint.V1.SHARELINK_PRESENTATION, produces = MediaType.APPLICATION_PDF_VALUE)
    @ApiResponses({
            @ApiResponse(code = 403, response = ApiErrorMessage.class, message = "The link is invalid or has expired"),
            @ApiResponse(code = 500, response = ApiErrorMessage.class, message = "There's been an unexpected error")
    })
    ...
    @GetMapping(value = Parameter.Path.SHARE_HASH + Endpoint.V1.VERIFY,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    @ApiResponses({
