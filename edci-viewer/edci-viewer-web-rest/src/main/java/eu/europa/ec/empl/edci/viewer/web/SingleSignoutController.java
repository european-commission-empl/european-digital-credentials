package eu.europa.ec.empl.edci.viewer.web;
...
public class SingleSignoutController implements ServletContextAware {
    ...
    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SingleSignoutController.class);
