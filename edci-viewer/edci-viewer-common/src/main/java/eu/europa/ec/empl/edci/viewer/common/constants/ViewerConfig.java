...
public class ViewerConfig extends EDCIConfig {
    public class Viewer {
        ...
        public static final String WALLET_DOWNLOAD = "wallet.download.url";
        public static final String WALLET_DOWNLOAD_DIPLOMA = "wallet.download.diploma.url";
        public static final String WALLET_DOWNLOAD_SHARED_JSON = "wallet.download.shared.json.url";
        public static final String WALLET_DOWNLOAD_VERIFIABLE_PRESENTATION_URL = "wallet.download.verifiable.presentation.url";
        public static final String WALLET_DOWNLOAD_VERIFIABLE_FROM_FILE_PRESENTATION_URL = "wallet.download.verifiable.from.file.presentation.url";
