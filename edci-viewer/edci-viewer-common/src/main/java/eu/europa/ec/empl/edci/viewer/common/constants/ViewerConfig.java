...
public class ViewerConfig extends EDCIConfig {
    ...
    public class Path {
        public static final String SECURITY_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/viewer/security.properties";
        public static final String VIEWER_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/viewer/viewer.properties";
        public static final String FRONT_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/viewer/viewer_front.properties";
    }
