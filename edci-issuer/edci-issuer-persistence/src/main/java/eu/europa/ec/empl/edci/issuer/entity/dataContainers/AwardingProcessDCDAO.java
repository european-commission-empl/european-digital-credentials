...
public class AwardingProcessDCDAO implements IGenericDAO, Emptiable {
    ...
    @OneToMany(orphanRemoval = true, cascade = CascadeType.ALL)
    @JoinTable(
            name = "FIELD_" + TABLE_SHORT + "_ADD_NOTES",
            joinColumns = @JoinColumn(name = TABLE_PK_REF),
    ...
    private Set<LearningAssessmentSpecDAO> used; //*
    ...
    @OneToOne(orphanRemoval = true, cascade = CascadeType.ALL)
    @JoinColumn(name = "EDU_SYSTEM_NOTE_PK", referencedColumnName = "PK")
    private CodeDTDAO educationalSystemNote;
    ...
    public Set<LearningAssessmentSpecDAO> getUsed() {
        return used;
    }

    public void setUsed(Set<LearningAssessmentSpecDAO> used) {
        this.used = used;
    }
...
//    }
    ...
    public CodeDTDAO getEducationalSystemNote() {
        return educationalSystemNote;
    }

    public void setEducationalSystemNote(CodeDTDAO educationalSystemNote) {
