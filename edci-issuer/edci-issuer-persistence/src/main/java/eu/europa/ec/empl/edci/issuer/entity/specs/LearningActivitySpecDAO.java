...
public class LearningActivitySpecDAO implements IAuditedDAO, IGenericDAO, IMultilangDAO, Identifiable, IOCBIdentifiedDAO {
   ...
   /* @CustomizableRelation(position = 7, labelKey = "custom.relation.activity.location.hasAddress",
    ...
    @CustomizableRelation(position = 10, labelKey = "custom.relation.activity.hasPart", relPath = "hasPart{#ID}",
            groupId = 21)
