...
public class LearningSpecificationDCDAO implements IGenericDAO, Emptiable {
    ...
    private NoteDTDAO entryRequirementNote; //0..1
    ...
    public URI getHasAccreditation() {
        return hasAccreditation;
    }

    public void setHasAccreditation(URI hasAccreditation) {
    ...
    public NoteDTDAO getEntryRequirementNote() {
        return entryRequirementNote;
    }

    public void setEntryRequirementNote(NoteDTDAO entryRequirementNote) {
