...
public class EntitlemSpecificationDCDAO implements IGenericDAO, Emptiable {
    ...
    @OneToMany(orphanRemoval = true, cascade = CascadeType.ALL)
    @JoinTable(
            name = "FIELD_" + TABLE_SHORT + "_LIMIT_NA_OCC",
            joinColumns = @JoinColumn(name = TABLE_PK_REF),
            inverseJoinColumns = @JoinColumn(name = CodeDTDAO.TABLE_PK_REF))
    ...
    private List<LearningAchSpecificationDCDAO> mayResultFrom; //*
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = TABLE_PK_REF),
            inverseJoinColumns = @JoinColumn(name = EntitlemSpecificationDCDAO.TABLE_PK_REF + "_SUB"))
    private List<EntitlemSpecificationDCDAO> specialisationOf; //*
    ...
    private Set<OrganizationSpecDAO> limitOrganisation; //*
    ...
    public List<LearningAchSpecificationDCDAO> getMayResultFrom() {
        return mayResultFrom;
    }

    public void setMayResultFrom(List<LearningAchSpecificationDCDAO> mayResultFrom) {
    ...
    public List<EntitlemSpecificationDCDAO> getSpecialisationOf() {
        return specialisationOf;
    }

    public void setSpecialisationOf(List<EntitlemSpecificationDCDAO> specialisationOf) {
        this.specialisationOf = specialisationOf;
    }

    public Set<OrganizationSpecDAO> getLimitOrganisation() {
        return limitOrganisation;
    }

    public void setLimitOrganisation(Set<OrganizationSpecDAO> limitOrganisation) {
