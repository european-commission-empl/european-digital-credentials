...
@Deprecated //Fields should be reviewed if used in the future
public class AwardingOpportunityDCDAO implements IGenericDAO {
    ...
    @OneToOne(orphanRemoval = true, cascade = CascadeType.ALL)
    @JoinColumn(name = "NEW_LOCATION_PK", referencedColumnName = "PK")
    ...
    private LearningAchSpecificationDCDAO learningAchievementSpecification; //1
    ...
    public LearningAchSpecificationDCDAO getLearningAchievementSpecification() {
        return learningAchievementSpecification;
    }

    public void setLearningAchievementSpecification(LearningAchSpecificationDCDAO learningAchievementSpecification) {
