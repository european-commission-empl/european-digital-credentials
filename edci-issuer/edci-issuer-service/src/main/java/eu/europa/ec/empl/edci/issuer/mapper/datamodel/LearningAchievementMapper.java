...
public interface LearningAchievementMapper {
    ...
    default LearningSpecificationDTO getSpecification(LearningSpecificationDCDAO learningSpecificationDCDAO) {
        ...
        if ((learningSpecificationDCDAO.getNqfLevel() != null && !learningSpecificationDCDAO.getNqfLevel().isEmpty()) ||
                (learningSpecificationDCDAO.getEqfLevel() != null && !learningSpecificationDCDAO.getEqfLevel().isEmpty()) ||
                (learningSpecificationDCDAO.getHasAccreditation() != null) ||
