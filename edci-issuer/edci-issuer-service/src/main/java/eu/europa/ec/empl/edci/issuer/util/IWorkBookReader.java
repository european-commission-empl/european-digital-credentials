    ...
    default String getStringCellValue(Cell cell) {
        ...
        if (!this.getValidator().isEmpty(object)) {
            ...
            if (object instanceof Date) {
                returnValue = ZonedDateTime.ofInstant(((Date) object).toInstant(), ZoneOffset.UTC).toString();
            } else if (object instanceof LocalDateTime) {
                returnValue = ZonedDateTime.ofInstant(((LocalDateTime) object).toInstant(ZoneOffset.UTC), ZoneOffset.UTC).toString();
            }
