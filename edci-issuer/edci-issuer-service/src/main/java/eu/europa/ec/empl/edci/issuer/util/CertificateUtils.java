...
public class CertificateUtils {
    ...
    public void overwriteCertificateFields(String filePath, Map<String, String> credentialIssuerInfo, @Nullable String resultingPath) throws IOException, ParseException, JsonLdError {
        this.overwriteCertificateFields(null, filePath, credentialIssuerInfo, resultingPath);
    }
     ...
     * */
    public void overwriteCertificateFields(AttachmentView mandatedIssueFile, String filePath, Map<String, String> credentialIssuerInfo, @Nullable String resultingPath) throws IOException, ParseException, JsonLdError {
        ...
        if (resultingPath == null) {
            ...
            fileService.createJSONLDFile(euroPassCredential, resultingPath);
        }


        /*} catch (Exception ex) {
            logger.error("Error overwriting certificate fields: " + ex.getMessage(), ex);
        }*/
