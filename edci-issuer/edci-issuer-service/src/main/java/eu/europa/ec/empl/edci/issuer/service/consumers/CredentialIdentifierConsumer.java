...
public class CredentialIdentifierConsumer implements Consumer<ConsumerContext> {
    ...
    public void accept(ConsumerContext context) {
        ...
        DeliveryDetailsDTO deliveryDetails = context.getCredentialUpload().getDeliveryDetails();
        if(deliveryDetails != null && deliveryDetails.getDisplayDetails() != null
                && deliveryDetails.getDisplayDetails().getBackground() != null
                && deliveryDetails.getDisplayDetails().getBackground().getId() == null) {
            MediaObjectDTO mediaObjectDTO = deliveryDetails.getDisplayDetails().getBackground();
