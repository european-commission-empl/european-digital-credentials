...
import eu.europa.ec.empl.edci.issuer.web.model.dataTypes.PeriodOfTimeDTView;
...
public class LearningActivitySpecView extends LearningActivitySpecLiteView {
    ...
    private List<PeriodOfTimeDTView> temporal; //0..*
    ...
    public List<PeriodOfTimeDTView> getTemporal() {
        return temporal;
    }

    public void setTemporal(List<PeriodOfTimeDTView> temporal) {
