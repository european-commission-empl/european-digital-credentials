...
public interface LearningActivitySpecRestMapper extends IRestMapper<LearningActivitySpecDAO, LearningActivitySpecView, LearningActivitySpecLiteView> {
    ...
    @Mappings({
            @Mapping(source = "dcType", target = "learningActivityType"),
            @Mapping(source = "homepage", target = "homePage")

    })
    LearningActSpecificationDCView toVOSpecification(LearningActSpecificationDCDAO dao);

    @Mappings({
            @Mapping(source = "learningActivityType", target = "dcType"),
            @Mapping(source = "homePage", target = "homepage")
    })
    LearningActSpecificationDCDAO toDAOSpecification(LearningActSpecificationDCView dao);
