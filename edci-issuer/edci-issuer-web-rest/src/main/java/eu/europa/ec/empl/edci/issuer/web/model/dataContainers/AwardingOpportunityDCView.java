...
public class AwardingOpportunityDCView extends DataContainerView {
    ...
    private LearningSpecificationDCView awardedLearningSpecification; //1
    ...
    public LearningSpecificationDCView getAwardedLearningSpecification() {
        return awardedLearningSpecification;
    }

    public void setAwardedLearningSpecification(LearningSpecificationDCView awardedLearningSpecification) {
