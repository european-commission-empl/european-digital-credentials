...
public class LearningAchievementResource implements CrudResource {
    ...
    public ResponseEntity<PagedResources<OrganizationSpecLiteView>> listAwardingBodies(
        ...
        return generateListResponse(learningAchievementDAO.getWasAwardedBy().getAwardingBody(), "/specs", organizationSpecRestMapper);
    ...
    public ResponseEntity<PagedResources<LearningActivitySpecLiteView>> listInfluencedBy(
        ...
        return generateListResponse(learningAchievementDAO.getWasInfluencedBy(), "/specs", learningActivitySpecRestMapper);
    ...
    public ResponseEntity<PagedResources<EntitlementSpecLiteView>> listEntitlesTo(
        ...
        return generateListResponse(learningAchievementDAO.getEntitlesTo(), "/specs", entitlementSpecRestMapper);
    ...
    public ResponseEntity<PagedResources<LearningAchievementSpecLiteView>> listSubAchievements(
        ...
        return generateListResponse(learningAchievementDAO.getHasPart(), "/specs", learningAchievementSpecRestMapper);
    ...
    public ResponseEntity<PagedResources<LearningOutcomeSpecLiteView>> listLearningOutcomes(
        ...
        return generateListResponse(learningAchievementDAO.getSpecifiedBy().getLearningOutcome(), "/specs", learningOutcomeSpecRestMapper);
