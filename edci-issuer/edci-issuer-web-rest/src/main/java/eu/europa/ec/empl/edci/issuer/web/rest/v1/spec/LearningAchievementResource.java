...
public class LearningAchievementResource implements CrudResource {
    ...
    public ResponseEntity<Resource<LearningAchievementSpecView>> createLearningAchievement(@RequestBody @Valid LearningAchievementSpecView learningAchievementView,
        ...
        LearningAchievementSpecDAO learningAchievementCreatedDAO = learningAchievementService.save(learningAchievementDAO,
                () -> {
                    learningAchievementDAO.setSpecifiedBy(learningAchievementDAO.getSpecifiedBy() == null ? new LearningAchSpecificationDCDAO() : learningAchievementDAO.getSpecifiedBy());
                    learningAchievementDAO.setAwardedBy(learningAchievementDAO.getAwardedBy() == null ? new AwardingProcessDCDAO() : learningAchievementDAO.getAwardedBy());
                    learningAchievementDAO.getAwardedBy().setAwardingBody(organizationSpecService.retrieveEntities(false, learningAchievementView.getRelAwardingBody().getOid()));
                    learningAchievementDAO.setProvenBy(assessmentSpecService.retrieveEntities(false, learningAchievementView.getRelProvenBy().getOid()));
                    learningAchievementDAO.setInfluencedBy(learningActivitySpecService.retrieveEntities(false, learningAchievementView.getRelInfluencedBy().getOid()));
                    ...
                    learningAchievementDAO.getSpecifiedBy().setAccreditation(retrieveEntities(accreditationSpecService, false, learningAchievementView.getRelAccreditation().getOid()));
                });
    ...
    @GetMapping(value = IssuerEndpoint.V1.SPECS + Parameter.Path.OID + IssuerEndpoint.V1.ACH_AWARDING_BODY,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseEntity<PagedResources<OrganizationSpecLiteView>> listAwardingBodiesAch(
            @ApiParam(required = true, value = "The LearningAchievement oid") @PathVariable(Parameter.OID) Long oid,
            @ApiParam(value = "locale") @RequestParam(value = Parameter.LOCALE, required = false) String locale
    ) throws Exception {
        ...
        if (learningAchievementDAO.getAwardedBy() == null) {
            learningAchievementDAO.setAwardedBy(new AwardingProcessDCDAO());
        }

        return generateListResponse(learningAchievementDAO.getAwardedBy().getAwardingBody(), "/specs", organizationSpecRestMapper, LocaleContextHolder.getLocale().toString());
    ...
    @PostMapping(value = IssuerEndpoint.V1.SPECS + Parameter.Path.OID + IssuerEndpoint.V1.ACH_AWARDING_BODY,
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseEntity<PagedResources<OrganizationSpecLiteView>> setAwardingBodiesAch(
            @ApiParam(required = true, value = "The LearningAchievement oid") @PathVariable(Parameter.OID) Long oid,
        ...
        learningAchievementDAO.getAwardedBy().setAwardingBody(entities);
    ...
    @ApiOperation(value = "Gets a list subresources (Assessment)")
    @GetMapping(value = IssuerEndpoint.V1.SPECS + Parameter.Path.OID + IssuerEndpoint.V1.ACH_PROVEN_BY,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseEntity<PagedResources<AssessmentSpecLiteView>> getProvenBy(
            @ApiParam(required = true, value = "The LearningAchievement oid") @PathVariable(Parameter.OID) Long oid,
            @ApiParam(value = "locale") @RequestParam(value = Parameter.LOCALE, required = false) String locale
    ) throws Exception {
        ...
        LearningAssessmentSpecDAO learnAss = null;

        return generateListResponse(learningAchievementDAO.getProvenBy(), "/specs", assessmentSpecRestMapper, LocaleContextHolder.getLocale().toString());
    ...
    public ResponseEntity<Resource<AssessmentSpecView>> setProvenBy(
        ...
        Set<LearningAssessmentSpecDAO> entities = retrieveEntities(assessmentSpecService, true, oids.getOid());

        learningAchievementDAO.setProvenBy(entities);

        learningAchievementService.save(learningAchievementDAO);

        return generateOkResponse(learningAchievementDAO.getProvenBy().iterator().next(), assessmentSpecRestMapper, generateLearningAchievementHateoas(learningAchievementDAO));
    ...
    public ResponseEntity deleteProvenBy(
        ...
        if (learningAchievementDAO.getProvenBy() != null) {
            learningAchievementDAO.getProvenBy().clear();
            learningAchievementService.save(learningAchievementDAO);
        }
    ...
    public ResponseEntity<PagedResources<LearningActivitySpecLiteView>> listInfluencedBy(
        ...
        return generateListResponse(learningAchievementDAO.getInfluencedBy(), "/specs", learningActivitySpecRestMapper, LocaleContextHolder.getLocale().toString());
    ...
    public ResponseEntity<PagedResources<LearningActivitySpecLiteView>> setInfluencedBy(
        ...
        learningAchievementDAO.setInfluencedBy(entities);
    ...
    public ResponseEntity<PagedResources<LearningOutcomeSpecLiteView>> listLearningOutcomes(
        ...
        if (learningAchievementDAO.getSpecifiedBy() == null) {
            learningAchievementDAO.setSpecifiedBy(new LearningAchSpecificationDCDAO());
        }
    ...
    @GetMapping(value = IssuerEndpoint.V1.SPECS + Parameter.Path.OID + IssuerEndpoint.V1.ORG_ACCREDITATION,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseEntity<PagedResources<AccreditationSpecLiteView>> listAchsAccreditation(
            @ApiParam(required = true, value = "The LearningAchievement oid") @PathVariable(Parameter.OID) Long oid,
            @ApiParam(value = "locale") @RequestParam(value = Parameter.LOCALE, required = false) String locale
    ) throws Exception {
        ...
        return generateListResponse(learningAchievementDAO.getSpecifiedBy().getAccreditation(), "/specs", accreditationSpecRestMapper, LocaleContextHolder.getLocale().toString());
    ...
    public ResponseEntity<PagedResources<AccreditationSpecLiteView>> setAccreditation(
        ...
        learningAchievementDAO.getSpecifiedBy().setAccreditation(entities);
    ...
    public Link[] generateLearningAchievementHateoas(LearningAchievementSpecDAO learningAchievementDAO) {
        ...
        if (learningAchievementDAO != null) {
            ...
            Link hateoasAC = ControllerLinkBuilder.linkTo(LearningAchievementResource.class)
                    .slash(IssuerEndpoint.V1.SPECS).slash(learningAchievementDAO.getPk())
                    .slash(IssuerEndpoint.V1.ORG_ACCREDITATION).withRel("accreditation");

            return new Link[]{
                    hateoasSelf, hateoasAW, hateoasPB, hateoasIB, hateoasET, hateoasSA, hateoasLO, hateoasAC
            };
