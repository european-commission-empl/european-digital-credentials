...
public interface FileRestMapper {
    ...
    CLElementBasicView toVO(ELementCLBasicDTO eLementCLBasicDTO);

    List<CLElementBasicView> toVO(List<ELementCLBasicDTO> eLementCLBasicDTO);

    Set<CLElementBasicView> toVOSet(Set<ELementCLBasicDTO> eLementCLBasicDTOS);
}
