...
public interface AssessmentSpecRestMapper extends IRestMapper<LearningAssessmentSpecDAO, AssessmentSpecView, AssessmentSpecLiteView> {

    @Mappings({
            @Mapping(source = "oid", target = "pk"),
            @Mapping(source = "additionalInfo.languages", target = "languages")
    })
    LearningAssessmentSpecDAO toDAO(AssessmentSpecView view);
    ...
    AssessmentSpecView toVO(LearningAssessmentSpecDAO dao);

    default AssessmentsListIssueView toVOListIssueView(Set<LearningAssessmentSpecDAO> learningAssessmentSpecDAOS) {
    ...
    @Override
    default String getDisplayName(LearningAssessmentSpecDAO dao, String locale) {
