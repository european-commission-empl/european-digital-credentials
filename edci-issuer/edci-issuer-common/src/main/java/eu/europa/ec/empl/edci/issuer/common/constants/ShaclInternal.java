...
public class ShaclInternal {
    ...
    public void shaclInternalPost() {
        ...
        shaclMap.put(this.getConfigService().getString(DataModelConstants.Properties.DIPLOMA_SUPPLEMENT), Arrays.asList("shacl/EDC-accredited", "shacl/EDC-generic-full", "shacl/EDC-generic-no-cv"));
