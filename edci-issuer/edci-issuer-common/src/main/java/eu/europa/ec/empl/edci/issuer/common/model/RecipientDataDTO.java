...
public class RecipientDataDTO {
    ...
    @CustomizableField(labelKey = "custom.field.person.address1", shouldInstanceMethodName = "true", position = 3, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".primaryDeliveryAddress", mandatory = true,
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")"  + ","
                    + Customization.VALIDATION_MANDATORY)
    private String deliveryAddress;

    @CustomizableField(labelKey = "custom.field.person.address2", shouldInstanceMethodName = "true", position = 4, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".secondaryDeliveryAddress", mandatory = true,
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")")
    private String secondaryDeliveryAddress;

    @CustomizableField(labelKey = "custom.field.person.email", shouldInstanceMethodName = "true", position = 5, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".contactPoint[0].emailAddress[0].id",
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")"
                    + "," + Customization.VALIDATION_EMAIL)
    private String emailAddress;

    @CustomizableField(labelKey = "custom.field.person.dateOfBirth", shouldInstanceMethodName = "true", position = 6, fieldType = FieldType.DATE, fieldPath = ENTITY_CODE + ".dateOfBirth",
    ...
    @CustomizableField(labelKey = "custom.field.person.birthCountry", shouldInstanceMethodName = "true", position = 7, fieldType = FieldType.CONTROLLED_LIST, fieldPath = ENTITY_CODE + ".placeOfBirth.address[0].countryCode")
    private ConceptDTO placeOfBirthCountry;

    @CustomizableCLField(targetFramework = ControlledList.COUNTRY, descriptionLabelKey = "customization.description.cl.country")
    @CustomizableField(labelKey = "custom.field.person.citizenshipCountry", shouldInstanceMethodName = "true", position = 8, fieldType = FieldType.CONTROLLED_LIST, fieldPath = ENTITY_CODE + ".citizenshipCountry", size = 3)
    ...
    @CustomizableField(labelKey = "custom.field.person.gender", shouldInstanceMethodName = "true", position = 9, fieldType = FieldType.CONTROLLED_LIST, fieldPath = ENTITY_CODE + ".gender")
    private ConceptDTO gender;

    @CustomizableCLField(targetFramework = ControlledList.COUNTRY, descriptionLabelKey = "customization.description.cl.country")
    @CustomizableField(labelKey = "custom.field.person.nationalIdentifier.spatialId", shouldInstanceMethodName = "true", position = 10, fieldType = FieldType.CONTROLLED_LIST, fieldPath = ENTITY_CODE + ".nationalID.spatial",
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")" + ","
    ...
    @CustomizableField(labelKey = "custom.field.person.nationalIdentifier.content", shouldInstanceMethodName = "true", position = 11, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".nationalID.notation",
    ...
    @CustomizableField(labelKey = "custom.field.person.otherIdentifier.scheme", shouldInstanceMethodName = "true", position = 12, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".identifier[0].schemeName",
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")"
    ...
    @CustomizableField(labelKey = "custom.field.person.otherIdentifier.content", shouldInstanceMethodName = "true", position = 13, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".identifier[0].notation",
            validation = Customization.VALIDATION_LENGTH + "(" + "255" + ")"
                    + Customization.VALIDATION_MANDATORYIF + "(" + Customization.FieldGroup.GROUP_OTHER_IDENTIFIER + ")"
            , relatesTo = ENTITY_CODE + ".identifier[0].schemeName")
    private String identifier;

    @CustomizableField(labelKey = "custom.field.person.address", shouldInstanceMethodName = "true", position = 14, fieldType = FieldType.TEXT, fieldPath = ENTITY_CODE + ".contactPoint[0].address[0].fullAddress.noteLiteral",
    ...
    @CustomizableCLField(targetFramework = ControlledList.COUNTRY, descriptionLabelKey = "customization.description.cl.country")
    @CustomizableField(labelKey = "custom.field.person.address.country", shouldInstanceMethodName = "true", position = 15, fieldType = FieldType.CONTROLLED_LIST, fieldPath = ENTITY_CODE + ".contactPoint[0].address[0].countryCode",
