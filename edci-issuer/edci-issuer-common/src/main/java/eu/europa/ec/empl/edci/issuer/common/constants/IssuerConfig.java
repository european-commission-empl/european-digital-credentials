...
public class IssuerConfig extends EDCIConfig {
    ...
    public class Issuer {
        ...
        public static final String WALLET_ADD_EMAIL_PATH = "wallet.credential.add.email.path";
        public static final String ALLOW_QSEALS_ONLY = "allow.qseals.only";
    ...
    public class Path {
        public static final String SECURITY_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/issuer/security.properties";
        public static final String ISSUER_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/issuer/issuer.properties";
        public static final String PROXY_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/issuer/proxy.properties";
        public static final String FRONT_FILE = "file:${CATALINA_BASE}/lib-client/classpathFILE/edci/issuer/issuer_front.properties";
    }
