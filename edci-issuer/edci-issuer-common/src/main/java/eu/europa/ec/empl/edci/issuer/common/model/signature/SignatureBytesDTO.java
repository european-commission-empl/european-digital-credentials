...
public class SignatureBytesDTO {
    ...
    public SignatureBytesDTO(String uuid, String bytes, Date date, DSSTimestampDTO dssTimestampDTO, String warningMsg) {
        this.uuid = uuid;
        this.bytes = bytes;
        this.date = date;
    ...
    public SignatureBytesDTO(String uuid, String bytes, Date date, DSSTimestampDTO dssTimestampDTO, String warningMsg, Boolean valid, String errorMessages) {
        this.uuid = uuid;
        this.bytes = bytes;
        this.date = date;
        this.dssTimestampDTO = dssTimestampDTO;
