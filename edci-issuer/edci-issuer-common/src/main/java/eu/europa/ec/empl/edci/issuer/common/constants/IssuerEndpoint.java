...
public class IssuerEndpoint extends EDCIEndpoint {
    ...
    public class V1 {
        ...
        public static final String ACCREDITATIONS_BASE = "/accreditations";
        public static final String ACCREDITATION_CHECK = "/check";

        public static final String GENERIC_ENTITY = "/entity";

        public static final String CREDENTIALS_ACCREDITATION = "/accreditation";
        public static final String CREDENTIALS_ISSUE = "/issue";
        public static final String CREDENTIALS_UPLOAD = "/upload";
        public static final String CREDENTIALS_DOWNLOAD = "/download";
        public static final String CREDENTIALS_SEAL = "/seal";
        public static final String CREDENTIALS_CREATE = "/create";
        ...
        public static final String CRED_ASSESSED_BY = "/assessedBy";
        ...
        public static final String ORG_SUB_ORGANIZATION_OF_REL = "/subOrganizationOf";
        public static final String ORG_CHILD_ORGANIZATION_REL = "/childOrganisation";
        public static final String ORG_ACCREDITATION = "/accreditation";

        public static final String ENT_AWARDING_BODY = "/awardingBody";
        public static final String ENT_HAS_PART = "/hasPart";
        public static final String ENT_VALID_WITH = "/validWith";

        public static final String ASS_AWARDING_BODY = "/awardingBody";
        public static final String ASS_HAS_PART = "/hasPart";
        public static final String ASS_ASSESSED_BY = "/assessedBy";

        public static final String ACC_ACCREDITING_AGENT = "/accreditingAgent";
        public static final String ACC_ORGANISATION = "/organisation";

        public static final String ACT_AWARDING_BODY = "/awardingBody";
