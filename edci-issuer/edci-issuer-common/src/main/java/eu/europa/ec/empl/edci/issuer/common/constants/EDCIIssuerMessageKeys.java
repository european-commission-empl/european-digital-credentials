...
public abstract class EDCIIssuerMessageKeys {
    ...
    public static class Sealing {
        ...
        public static final String CREDENTIALS_DELIVERY_ADDRESS_ERROR = "upload.credential.error.address";
        public static final String CREDENTIALS_DELIVERY_ADDRESS_ERROR_WITH_FILE = "upload.credential.error.address.file";
