...
export const environment = {
    ...
    accreditationLearnLink : window['EDCIContext'] ? window['EDCIContext'].accreditationLink : 'https://europa.eu/europass/en/preparing-credentials-european-digital-credentials-learning',
