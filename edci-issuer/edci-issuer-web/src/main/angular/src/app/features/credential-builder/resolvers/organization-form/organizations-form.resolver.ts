...
export class OrganizationsFormResolver implements Resolve<OrganizationSpecView> {
    constructor(
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<OrganizationSpecView> {
        ...
        if (routeID && currentLanguage) {
            ...
            return this.api.getOrganization(routeID, currentLanguage).pipe(
                take(1),
                catchError(() => {
