...
export class OrganizationsModalComponent implements OnInit, OnDestroy {
            ...
            if (oid !== null) {
                this.organizationsListContent.forEach(organization => {
                    if (organization['oid'] === oid[0]) {
                        ...
                        this.selectedParentOrganization = organization;
                    }
                });
    ...
    onEntityRemoved($event) {
        ...
        switch ($event.type) {
        case 'organization':
            this.selectedParentOrganization = null;
            this.shownOrganization.oid = -1;
            this.shownOrganization.title = '';
            this.loadingModal = false;
            break;
        ...
        this.api
            ...
            .subscribe((parentOrganization: ResourceOrganizationSpecView) => {
                if (parentOrganization !== null) {
                    ...
                    this.shownOrganization.oid = parentOrganization.oid;
                    this.shownOrganization.title = parentOrganization.defaultTitle;
                }
            });
    }
