...
export class CredentialBuilderService {
    ...
    private closeIssuingModal$ = new BehaviorSubject<string>('');
    closeIssuingModalObservable = this.closeIssuingModal$.asObservable();

    private issuingModalState$ = new BehaviorSubject<string>('');
    issuingModalStateObservable = this.issuingModalState$.asObservable();

    private issuingModalHeaderTitle$ = new BehaviorSubject<string>('');
    issuingModalHeaderTitleObservable = this.issuingModalHeaderTitle$.asObservable();
    ...
    setIssuingModalState(state: string) {
        this.issuingModalState$.next(state);
    }

    setIssuingModalHeaderTitle(title: string) {
        this.issuingModalHeaderTitle$.next(title);
    }

    setCloseIssuingModal(close: string) {
        this.closeIssuingModal$.next(close);
    }
