...
export class V1Service {
    ...
    /**
     * Checks if an Accreditation ID exists
     * 
     * @param uri 
     * @param lang 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public doesAccreditationExist(uri: string, lang: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public doesAccreditationExist(uri: string, lang: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public doesAccreditationExist(uri: string, lang: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public doesAccreditationExist(uri: string, lang: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (uri === null || uri === undefined) {
            throw new Error('Required parameter uri was null or undefined when calling doesAccreditationExist.');
        }

        if (lang === null || lang === undefined) {
            throw new Error('Required parameter lang was null or undefined when calling doesAccreditationExist.');
        }
        ...
        return this.httpClient.get<any>(`${this.basePath}/v1/credentials/accreditation`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
