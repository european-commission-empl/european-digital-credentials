...
export class AutocompleteComponent implements OnInit, AfterViewInit {
    ...
    @Output() onEntityRemoved: EventEmitter<{ type: string; oid: number }> =
        new EventEmitter<{ type: string; oid: number }>();
    ...
    @Output() assessmentContent: EventEmitter<PagedResourcesAssessmentSpecLiteView> =
    new EventEmitter<PagedResourcesAssessmentSpecLiteView>();
    @Output() entitlementContent: EventEmitter<PagedResourcesEntitlementSpecLiteView> =
    new EventEmitter<PagedResourcesEntitlementSpecLiteView>();
    @Output() organizationContent: EventEmitter<PagedResourcesOrganizationSpecLiteView> =
    new EventEmitter<PagedResourcesOrganizationSpecLiteView>();
    ...
    onClick() {
        if ((!this.textToSearch || this.textToSearch !== '') && this.entityType) {
            this.searchAllItems();
        }
    }
        ...
        this.api
            ...
            .subscribe((results: PagedResourcesAssessmentSpecLiteView) => {
                if (results.content.length) {
                    ...
                    this.assessmentContent.emit(results);
                } else {
                    this.searchList = this.createEmptyResultsMessage();
                }
                this.textToSearch = '';
        ...
        this.api
            ...
            .subscribe((results: PagedResourcesOrganizationSpecLiteView) => {
                if (results.content.length) {
                    ...
                    this.organizationContent.emit(results);
                } else {
                    this.searchList = this.createEmptyResultsMessage();
                }
                this.textToSearch = '';
        ...
        this.api
            ...
            .subscribe((results: PagedResourcesEntitlementSpecLiteView) => {
                if (results.content.length) {
                    ...
                    this.entitlementContent.emit(results);
                } else {
                    this.searchList = this.createEmptyResultsMessage();
                }
                this.textToSearch = '';
