                ...
                (entity: Page) => {
                    ...
                    entity.content.forEach((element: CodeDTView) => {
                        ...
                        if (this.entityType === 'credential') {
                            if (
                                element.uri === 'http://data.europa.eu/snb/credential/e34929035b' ||
                                element.uri === 'http://data.europa.eu/snb/credential/6dff8a0f87' ||
                                element.uri === 'http://data.europa.eu/snb/credential/6cf8e68c43'
                            ) {
