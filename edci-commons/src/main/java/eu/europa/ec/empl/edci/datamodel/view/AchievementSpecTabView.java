...
AchievementSpecTabView implements ITabView {
    ...
    private String learningOutcomeDescription; //This field is the one presented in the viewer and used in the OCB as specifiedBy description
    ...
    public void setLearningOutcomeDescription(String learningOutcomeDescription) {
