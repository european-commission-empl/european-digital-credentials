...
public class CorsFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        ((HttpServletResponse) servletResponse).addHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS, HttpHeaders.CONTENT_TYPE + ", x-requested-with, " + HttpHeaders.AUTHORIZATION + ", x-xsrf-token," + HttpHeaders.CACHE_CONTROL);
