...
public class Identifier implements Nameable {
    ...
    public void setSchemeID(String identifierSchemeName) {
        this.identifierSchemeName = identifierSchemeName;
    }
    ...
    public void setSchemeName(String identifierSchemeName) {
        this.identifierSchemeName = identifierSchemeName;
    }
    ...
    public void setSchemeAgencyName(String identifierSchemeAgencyName) {
        this.identifierSchemeAgencyName = identifierSchemeAgencyName;
    }
    ...
    public void setType(List<String> identifierType) {
        this.identifierType = identifierType;
    }
    ...
    public void setTypes(List<String> identifierType) {
        this.identifierType = identifierType;
    }
