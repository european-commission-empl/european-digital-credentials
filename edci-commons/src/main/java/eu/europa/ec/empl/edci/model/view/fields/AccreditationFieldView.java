...
public class AccreditationFieldView {
    ...
    private List<OrganizationTabView> organisation;
    ...
    public List<OrganizationTabView> getOrganisation() {
        return organisation;
    }

    public void setOrganisation(List<OrganizationTabView> organisation) {
