...
public class MockFactoryUtil {
    ...
    public String createNexusTestCredentialXML() throws Exception {
        String credentialXml = edciCredentialModelUtil.getXmlFromInputString(getClass().getClassLoader().getResourceAsStream("issuer_test_seal_credential.xml"));
        return edciCredentialModelUtil.addUploadMultipleCredentialsWrapper(credentialXml);
    }
