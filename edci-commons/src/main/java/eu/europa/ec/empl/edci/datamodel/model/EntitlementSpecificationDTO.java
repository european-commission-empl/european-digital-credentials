...
public class EntitlementSpecificationDTO implements Identifiable, Nameable {
    ...
    private OrganizationDTO limitOrganization; //?
    ...
    public OrganizationDTO getLimitOrganization() {
        return limitOrganization;
    }

    public void setLimitOrganization(OrganizationDTO limitOrganization) {
