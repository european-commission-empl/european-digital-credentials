...
//    @NotNull(message = MessageKeys.Validation.VALIDATION_LEARNINGSPEC_TITLE_NOTNULL)
    ...
    public List<Identifier> getAllAvailableIdentifiers() {
        ...
        if (this.getIdentifier() != null) identifiers.addAll(this.getIdentifier());
        return identifiers;
    }
    ...
    public List<Code> getType() {
        return this.learningOpportunityType;
    }
    ...
    public Note getDescription() {
        return this.learningOutcomeDescription;
    }
    ...
    public List<Code> getHasISCED_FCode() {
        return this.iscedFCode;
    }

    public List<Code> getHasISCED_FCodes() {
        return this.iscedFCode;
    }

    public List<Code> getHasISCEDFCode() {
        return this.iscedFCode;
    }

    public List<Code> getHasISCEDFCodes() {
        return this.iscedFCode;
    }

    public List<Code> getHasEducationSubject() {
        return this.educationSubject;
    }

    public List<Code> getHasEducationSubjects() {
        return this.educationSubject;
    }

    public Score getHasECTSCreditPoints() {
        return this.ectsCreditPoints;
    }

    public List<Score> getHasCreditPoints() {
        return this.creditPoints;
    }

    public List<Code> getHasEducationLevel() {
        return this.educationLevel;
    }

    public List<Code> getHasEducationLevels() {
        return this.educationLevel;
    }

    public Code getLearningSettingType() {
        return this.learningSetting;
    }

    public Note getEntryRequirementsNote() {
        return this.entryRequirementNote;
    }

    public List<AwardingOpportunityDTO> getAwardingOpportunities() {
