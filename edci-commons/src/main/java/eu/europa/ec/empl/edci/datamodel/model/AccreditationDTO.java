...
@EDCIIdentifier(ignoreProcessing = true)
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder = {"id", "identifier", "accreditationType", "title", "description", "decision", "report", "organization", "limitQualification", "limitField", "limitEqfLevel", "limitJurisdiction"
...
public class AccreditationDTO implements Identifiable, Nameable {
    ...
    public void setType(Code accreditationType) {
        this.accreditationType = accreditationType;
    }
    ...
    public List<Code> getLimitEQFLevels() {
        return this.limitEqfLevel;
    }

    public void setLimitEQFLevels(List<Code> limitEqfLevel) {
        this.limitEqfLevel = limitEqfLevel;
    }
    ...
    public void setHomepages(List<WebDocumentDTO> homePage) {
        this.homePage = homePage;
    }
    ...
    public void setSupplementaryDoc(List<WebDocumentDTO> homePage) {
        this.homePage = homePage;
    }
    ...
    public void setSupplementaryDocs(List<WebDocumentDTO> homePage) {
        this.homePage = homePage;
    }
