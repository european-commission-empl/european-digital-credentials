...
public class LearningActivityDTO implements RootEntity, Nameable {
    ...
    private String pk;
    @XmlAttribute
    @NotNull(message = MessageKeys.Validation.VALIDATION_LEARNINGACTIVITY_ID_NOTNULL)
    private URI id; //1
    @Valid
    private List<Identifier> identifier; //*
    @Valid
    @NotNull(message = MessageKeys.Validation.VALIDATION_LEARNINGACTIVITY_TITLE_NOTNULL)
   ...
   /* public LearningOpportunityDTO getUsedLearningOpportunity() {
        return usedLearningOpportunity;
    }

    public void setUsedLearningOpportunity(LearningOpportunityDTO usedLearningOpportunity) {
