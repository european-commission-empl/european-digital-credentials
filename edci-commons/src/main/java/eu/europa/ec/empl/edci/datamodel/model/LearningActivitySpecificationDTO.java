...
public class LearningActivitySpecificationDTO implements Identifiable, Nameable {
    ...
    @XmlID
    @XmlIDExtension
    @NotNull(message = EDCIMessageKeys.Validation.VALIDATION_LEARNINGACTIVITYSPEC_ID_NOTNULL)
    private URI id; //1
    @XmlTransient
    private String pk;
    @Valid
    ...
    public void setType(List<Code> learningActivityType) {
        this.learningActivityType = learningActivityType;
    }
    ...
    public void setSupplementaryDoc(List<WebDocumentDTO> supplementaryDocument) {
        this.supplementaryDocument = supplementaryDocument;
    }
