...
@XmlType(propOrder = {"identifier", "type", "primaryLanguage", "availableLanguages", "issuanceDate", "issued", "expirationDate", "issuer", "title", "description", "credentialSubject", "subCredentialsXML", "learningSpecificationReferences", "learningOutcomeReferences", "learningActivitySpecificationReferences"
        , "assessmentSpecificationReferences", "entitlementSpecificationReferences", "learningOpportunityReferences", "organisationReferences", "awardingProcessReferences", "accreditationReferences", "scoringSchemeReferences", "display", "proof"})
...
public class EuropassCredentialDTO extends VerifiableCredentialDTO implements CredentialHolderDTO {
    ...
    public String getEmail() {
        PersonDTO cs = this.getCredentialSubject();
        Optional<ContactPoint> contactPoint = Optional.empty();
        if (cs != null && cs.getContactPoint() != null) {
            contactPoint = cs.getContactPoint().stream().filter(cPoint -> cPoint.getEmail() != null && !cPoint.getEmail().isEmpty()).findFirst();
        }
    ...
    public String getWalletAddress() {
        ...
        Optional<ContactPoint> contactPoint = Optional.empty();
        if (cs != null && cs.getContactPoint() != null) {
            contactPoint = cs.getContactPoint().stream().filter(cPoint -> cPoint.getWalletAddress() != null && !cPoint.getWalletAddress().isEmpty()).findFirst();
        }
    ...
    //XML Getter
    public DisplayParametersDTO getDisplayParameters() {
        return this.display;
    }

    /**
     * To be checked when subcreds are reintroduced
     * public List<String> getContains() {
     * return this.subCredentialsXML;
     * }
     **/

    public List<MediaObject> getAttachment() {
        return this.attachmentList;
    }

    public List<MediaObject> getAttachments() {
        return this.attachmentList;
    }
