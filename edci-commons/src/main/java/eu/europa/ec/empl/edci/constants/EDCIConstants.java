...
public class EDCIConstants {
    ...
    public static final String DEFAULT_VIEWER_DIPLOMA_HTML_PATH = "edci/diploma_default.html";
    public static final String DEFAULT_VIEWER_DIPLOMA_THYMELEAF_PATH = "edci/diploma_default_thymeleaf.html";
    public static final String DEFAULT_VIEWER_DIPLOMA_BKG_IMG_PATH = "edci/diploma-background.png";
    public static final String DEFAULT_VIEWER_LOGO_BKG_IMG_PATH = "edci/logo_default.png";
    ...
    public static class XML {
        ...
        public static final String NAMESPACE_CRED_URI = "http://data.europa.eu/europass/model/credentials/w3c#";
        public static final String MULTIPLE_CREDENDTIALS_WRAPPER_OPEN = "<europassCredentials>";
        public static final String MULTIPLE_CREDENDTIALS_WRAPPER_CLOSE = "</europassCredentials>";
