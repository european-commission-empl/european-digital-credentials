...
public class EDCIOauth2TokenService {
    ...
    private void handleOIDCException(OIDCException e) {
        if (e.getError().equals("invalid_grant") || e.getError().equals("invalid_token")) {
            this.getEdciAuthenticationService().endSession();
            throw new EDCIException(ErrorCode.SESSION_EXPIRED);
        } else {
