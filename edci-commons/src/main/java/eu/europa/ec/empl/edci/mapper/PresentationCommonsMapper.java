...
public interface PresentationCommonsMapper {
    ...
    default MediaObject toMediaObject(URI mediaObjectUri) {
    ...
    default LinkFieldView toLinkCode(Code code) {
        ...
        try {
            ...
            if (code.getTargetFramework() != null) {
                lfv.setTargetFramework(code.getTargetFramework().getStringContent(LocaleContextHolder.getLocale().getLanguage()));
            }
