...
public class AssessmentSpecificationDTO implements Identifiable, Nameable {
    ...
    public void setType(List<Code> assessmentType) {
        this.assessmentType = assessmentType;
    }
    ...
    public void setTypes(List<Code> assessmentType) {
        this.assessmentType = assessmentType;
    }
    ...
    public void setAltLabel(List<Text> alternativeLabel) {
        this.alternativeLabel = alternativeLabel;
    }
    ...
    public void setAltLabels(List<Text> alternativeLabel) {
        this.alternativeLabel = alternativeLabel;
    }
