...
public class EDCIJAXBMarshalListener extends Marshaller.Listener {
    ...
    private static final Logger logger = LogManager.getLogger(EDCIJAXBMarshalListener.class);
    ...
    public void beforeMarshal(Object source) {
        ...
        if (source instanceof EuropassCredentialDTO) {
            ...
            //References
            Set<LearningSpecificationDTO> learningSpecificationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(LearningSpecificationDTO.class, europassCredentialDTO);
            Set<LearningOutcomeDTO> learningOutcomeDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(LearningOutcomeDTO.class, europassCredentialDTO);
            Set<LearningActivitySpecificationDTO> learningActivitySpecificationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(LearningActivitySpecificationDTO.class, europassCredentialDTO);
            Set<AssessmentSpecificationDTO> assessmentSpecificationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(AssessmentSpecificationDTO.class, europassCredentialDTO);
            Set<EntitlementSpecificationDTO> entitlementSpecificationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(EntitlementSpecificationDTO.class, europassCredentialDTO);
            Set<LearningOpportunityDTO> learningOpportunityDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(LearningOpportunityDTO.class, europassCredentialDTO);
            Set<OrganizationDTO> organizationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(OrganizationDTO.class, europassCredentialDTO);
            Set<AccreditationDTO> accreditationDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(AccreditationDTO.class, europassCredentialDTO);
            Set<ScoringSchemeDTO> scoringSchemeDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(ScoringSchemeDTO.class, europassCredentialDTO);
            Set<AwardingProcessDTO> awardingProcessDTOS = this.getReflectiveUtil().getUniqueInnerObjectsOfType(AwardingProcessDTO.class, europassCredentialDTO);
