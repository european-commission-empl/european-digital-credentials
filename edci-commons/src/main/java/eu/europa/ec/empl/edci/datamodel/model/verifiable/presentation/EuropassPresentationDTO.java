...
public class EuropassPresentationDTO extends VerifiablePresentationDTO implements CredentialHolderDTO {
    ...
    public void setEuropassCredential(EuropassCredentialDTO verifiableCredential) {
        this.verifiableCredential = verifiableCredential;
    }
    ...
    public void setVerificationCheck(List<VerificationCheckDTO> verifications) {
        this.verifications = verifications;
    }
    ...
    public void setVerificationChecks(List<VerificationCheckDTO> verifications) {
        this.verifications = verifications;
    }
}
