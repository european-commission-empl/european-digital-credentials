...
public class EDCICredentialModelUtil {
    ...
    public Code getTypeCode(Class<? extends CredentialHolderDTO> presentationClass, String type) {
        ...
        //TODO Remove when the PO has all the concepts translated
        if (credentialType == null && !Locale.ENGLISH.getLanguage().equals(LocaleContextHolder.getLocale().toString())) {
            credentialType = controlledListCommonsService.searchConceptByUri(clType.getUrl(), type, Locale.ENGLISH.getLanguage());
        }
     ...
     **/
    public Set<String> getAllUniqueLanguages(LocalizableDTO... localizables) {
