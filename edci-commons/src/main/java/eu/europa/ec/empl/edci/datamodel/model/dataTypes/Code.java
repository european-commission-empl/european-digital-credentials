...
public class Code implements Nameable { //See EDCI-751 for any doubts here
    ...
    public void setTargetFrameworkUrl(String targetFrameworkURI) {
        this.targetFrameworkURI = targetFrameworkURI;
    }

    public void setTargetFrameworkName(Text targetFramework) {
        this.targetFramework = targetFramework;
    }

    @Override
    public String toString() {
        return this.targetName != null ? this.targetName.getStringContent() : this.getUri();
    }
}