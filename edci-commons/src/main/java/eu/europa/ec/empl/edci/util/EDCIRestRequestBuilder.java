...
public class EDCIRestRequestBuilder {
    ...
    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(EDCIRestRequestBuilder.class);
    ...
    public <T> EDCIExecute<ResponseEntity<Resource<T>>> buildRequest(ParameterizedTypeReference<Resource<T>> responseType) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Building REST call -> " + httpMethod + ": " + url);
        }
