...
public class ResourcesUtilTest extends AbstractUnitBaseTest {
    ...
    public void findAllObjectsRecInList_shouldGetAllElems_searchingThroughAllTheRelations() throws Exception {
        ...
        Assert.assertEquals(6, resourcesUtil.findAllObjectsInRecursivily(cred, Identifiable.class, Identifiable.class).stream().collect(Collectors.toSet()).size());
    ...
    public void findAllObjectsRecInList_shouldGetAllPersonRelated_searchingThroughAllThePersonObjects() throws Exception {
        ...
        Assert.assertEquals(4, resourcesUtil.findAllObjectsInRecursivily(cred, Identifiable.class, PersonDTO.class).stream().collect(Collectors.toSet()).size());
    ...
    public void findAllObjectsRecInList_shouldGetAllPersonAndAchRelated_searchingThroughAllThePersonAndAchObjects() throws Exception {
        ...
        Assert.assertEquals(6, resourcesUtil.findAllObjectsInRecursivily(cred, Identifiable.class, PersonDTO.class, LearningAchievementDTO.class).stream().collect(Collectors.toSet()).size());
